...
void kuic::congestion::rtt::update_recent_min_rtt(kuic::kuic_time_t sample, kuic::special_clock &now) {
...
void kuic::congestion::rtt::update_rtt(kuic::kuic_time_t send_delta, kuic::kuic_time_t ack_delay, kuic::special_clock &now) {
